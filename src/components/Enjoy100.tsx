...
ひざ掛けをご用意しています。`
    ...
    },
    {
      title: "強さについて",
      icon: "💪",
      content: `強く押すほど深く届くわけではありません。
筋肉が圧に慣れてきたとき、はじめて指は奥に入っていきます。
「もう少し強く」はいつでも言ってください。`
    },
    {
      title: "初めての方へ",
      icon: "🔰",
      content: "「足つぼって痛いのかな…」と緊張される方も多いですが、強さは必ず伺いながら調整します。初回は、合わないと感じたらお代は頂戴しない制度もありますので、気負わずいらしてください。"
    }
  ];
