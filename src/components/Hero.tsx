...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-center px-8 md:px-20 overflow-hidden bg-white text-black">
      <div className="absolute top-0 left-0 w-1/3 prism-line" />
      <div className="relative z-10 w-full max-w-5xl text-left">
        ...
        <p className="rv rv-d3 font-accent text-[0.7rem] tracking-[0.25em] uppercase text-neutral-500 border-l border-neutral-300 pl-4">
          足つぼ ・ 足揉み専門店
        </p>
      </div>
      <div className="absolute bottom-10 left-8 md:left-20 flex flex-col items-start gap-2 rv rv-d3">
        ...
        <div className="w-px h-10 bg-gradient-to-b from-neutral-500 to-transparent ml-2" />
      </div>
    </section>
  );
}
