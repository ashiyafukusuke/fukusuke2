  ...
  const menus = [
    {
      ...
      price: "4,500円",
      desc: "サクッとリセット",
      content: "足元に溜まった日々の重力を、短時間で手放すコース。足裏からふくらはぎまでをテンポ良く、かつ的確に捉え、滞った血流を促します。忙しい日常の隙間に『自分の身体の輪郭を取り戻す』ための、心地よく鋭いリセットの時間です。",
    ...
    },
    {
      ...
      price: "6,500円",
      desc: "定番の全身アプローチ",
      content: "イタキモが目指す『意識の変容』を最も深く味わえる基本コース。身体の構造に基づいた緻密な圧が、足裏から全身の神経へと波及していきます。痛みを越えた先にある深い脱力感。左足が終わる頃には、多くの方が微睡みの中で意識を溶かし始めます。",
      color: "border-divider",
      bg: "bg-cardlight",
      badges: [
    ...
    },
    {
      ...
      price: "9,000円",
      desc: "極上のリセット",
      content: "足裏から全身へと広がる余韻を、限界まで深める極上のコース。慢性的な緊張や、奥底にこびりついた疲労の芯まで時間をかけて徹底的にほどいていきます。当店特有のまどろみと浮遊感を少しでも長く味わいたい方に向けたコースです。",
      color: "border-divider",
      bg: "bg-card",
      badges: [
