...
import { Noto_Sans_JP, Noto_Serif_JP, Dela_Gothic_One } from "next/font/google";
...
export const metadata: Metadata = {
  ...
  description: "西東京市ひばりが丘の足つぼ専門店「イタキモ」。最初から最後まで、イタキモチイイが続く。体重移動で揉むから、最後の10分も同じ圧。初回は合わなければ無料。",
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="ja" className="scroll-smooth">
      ...
      <body className={`${notoSans.variable} ${notoSerif.variable} ${delaGothic.variable} font-sans bg-bg text-ink font-medium antialiased`}>
        {children}
